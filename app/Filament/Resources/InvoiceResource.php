...
class InvoiceResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form->columns(4)->schema([
            Forms\Components\TextInput::make("title")->columnSpan(2)->minLength(3)->maxLength(256)->required(),
            Forms\Components\TextInput::make("partner")->columnSpan(2)->minLength(1)->maxLength(256)->required(),
            Forms\Components\Select::make("type")
                ...
                ->required(),
            Forms\Components\DatePicker::make("date_issue")->label("Date of issue"),
            Forms\Components\DatePicker::make("date_paid")->label("Date of payment"),
            ...
            Forms\Components\Repeater::make("items")
                ...
                ->schema([
                    Forms\Components\TextInput::make("name")->columnSpan(7)->minLength(3)->maxLength(256)->required(),
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make("type")
                    ...
                    ->searchable()
                    ->sortable(),
                Tables\Columns\TextColumn::make("partner")->searchable()->sortable(),
